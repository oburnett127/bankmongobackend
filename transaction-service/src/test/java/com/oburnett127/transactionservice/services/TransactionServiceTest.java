...
public class TransactionServiceTest {
    ...
    public void testGetTransaction(final UUID id) {
    ...
    public void testWithdraw(final UUID id, final BigDecimal amount, final Transaction Transaction) {
    ...
    public void testDeposit(final UUID id, final BigDecimal amount, Transaction Transaction) {
        Mockito.when(TransactionDao.getTransaction(id)).thenReturn(Transaction);
    ...
    public void testDepositCheck(final UUID id,  final BigDecimal amount, Transaction Transaction,
    ...
    public void testTransfer(final UUID idSender, final UUID idReceiver, final BigDecimal amount, Transaction senderTransaction,
